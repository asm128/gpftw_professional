...
// --- Initialize console.
	...
	ree_if(errored(::cho::updateSizeDependentTarget(applicationInstance.BitmapOffscreen.Texels, applicationInstance.BitmapOffscreen.View, applicationInstance.MainDisplay.Size)), "Cannot update offscreen and this could cause an invalid memory access later on.");
	...
	error_if(errored(::cho::grid_copy		(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureBackgroundDay.View, dstOffsetDay)), "I believe this never fails.");
	error_if(errored(::cho::grid_copy		(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureBackgroundNight.View, dstOffsetNight)), "I believe this never fails.");
	error_if(errored(::cho::grid_copy		(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, dstOffsetNight, ::cho::SRectangle2D<uint32_t>{{0,0}, {9, 128}})), "I believe this never fails.");
	...
	uint32_t																	lineOffset									= 0;
	{
		...
		for(int32_t iChar = 0; iChar < (int32_t)::cho::size(testText0) - 1; ++iChar) {
			...
			error_if(errored(::cho::grid_copy(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, {dstTextOffset + dstRect0.Offset, dstRect0.Size}, srcRect0)), "I believe this never fails.");
		}
	}
	++lineOffset;
	{
		...
		for(int32_t iChar = 0; iChar < (int32_t)::cho::size(testText0) - 1; ++iChar) {
			...
			const ::cho::SRectangle2D<int32_t>												srcRect0								= ::cho::SRectangle2D<int32_t>{{coordCharTable.x, (int32_t)applicationInstance.TextureFont.View.height() - sizeCharCell.y - coordCharTable.y}, sizeCharCell};
			error_if(errored(::cho::grid_copy(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, dstTextOffset + dstOffset1, srcRect0)), "I believe this never fails.");
		}
	}
	++lineOffset;
	{
		...
		drawTextFixedSize(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, 32, dstOffsetY, sizeCharCell, {testText0, ::cho::size(testText0) -1}, dstTextOffset);
	}
	++lineOffset;
	...
	error_if(errored(::cho::grid_copy(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, dstRect0, srcRect0.Offset)), "I believe this never fails.");
	error_if(errored(::cho::grid_copy(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, dstRect1.Offset, srcRect1.Offset)), "I believe this never fails.");
	error_if(errored(::cho::grid_copy(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, ::cho::SCoord2<uint32_t>{mainWindow.Size.x - applicationInstance.TextureFont.View.width() / 2, dstRect1.Offset.y}, srcRect1.Offset)), "I believe this never fails.");
	error_if(errored(::cho::grid_copy(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, dstRect2.Offset, srcRect2)), "I believe this never fails.");
	error_if(errored(::cho::grid_copy(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, dstRect3, srcRect3)), "I believe this never fails.");
	error_if(errored(::cho::grid_copy(applicationInstance.BitmapOffscreen.View, applicationInstance.TextureFont.View, dstRect4, srcRect4)), "I believe this never fails.");
	return 0;
}

...
static constexpr	const SWeaponProperties					weaponProperties []					=   
	...
	,	{"Plasma Gun"		, WEAPON_TYPE_PLASMA	, SHOT_TYPE_SINGLE,  900.f, 0.3f / 2, 1500}
	,	{"Bubble Gun"		, WEAPON_TYPE_BUBBLE	, SHOT_TYPE_SINGLE, 1000.f, 0.2f / 2, 1000}
	,	{"Electricity Gun"	, WEAPON_TYPE_SPARK		, SHOT_TYPE_SINGLE, 1000.f, 0.2f / 2, 1000}
	,	{"Radiation Gun"	, WEAPON_TYPE_POISON	, SHOT_TYPE_SINGLE,  800.f, 0.2f / 2, 1000}
	,	{"Fire Gun"			, WEAPON_TYPE_FIRE		, SHOT_TYPE_SINGLE,  700.f, 0.1f / 2,  750}
	,	{"Stone Gun"		, WEAPON_TYPE_ROCK		, SHOT_TYPE_SINGLE,  100.f, 0.1f / 2,  750}

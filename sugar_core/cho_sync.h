...
#			define cho_sync_exchange(nCount)						( InterlockedExchange64 ( &nCount ) )
#		elif (defined( _WIN32 ) || defined( WIN32 ))				 
#			define cho_sync_increment								sync_increment
#			define cho_sync_decrement								sync_decrement
#			define cho_sync_exchange								sync_exchange 
...
#	endif
#else
#	define cho_sync_increment(nCount)						(++(nCount))
#	define cho_sync_decrement(nCount)						(--(nCount))
#	define cho_sync_exchange(Target, Value)					(Target = Value)

...
#ifndef CHO_MATRIX_H_298374982374
#define CHO_MATRIX_H_298374982374
...
namespace cho 
{
	...
	struct SMatrix4 {
		...
		constexpr			_TCoord3			InverseTranslate			(const _TCoord3& vec)															const	noexcept	{ return { vec.x - _41, vec.y - _42, vec.z - _43 }; }
							void				InverseTranslateInPlace		(_TCoord3& vec	)																const	noexcept	{ vec.x -= _41; vec.y -= _42; vec.z -= _43; }
		...
		//}
			...
			*this									= 
			...
			::cho::SPairSinCos							angleSinCos					= ::cho::getSinCos(angle);
		...
		inline				void				Rotation					(_tBase x, _tBase y, _tBase z)																		{ return Rotation({x, y, z}); }
			...
			::cho::SPairSinCos							yaw							= ::cho::getSinCos(vc.z);
			::cho::SPairSinCos							pitch						= ::cho::getSinCos(vc.y);
			::cho::SPairSinCos							roll						= ::cho::getSinCos(vc.x);
		...
		//	return *this;
			...
			::cho::SPairSinCos							pairSinCos					= ::cho::getSinCos(a);
			...
			_44										= (_tBase)1;
							...
							void				SetOrientation				(const ::cho::SQuaternion<_tBase>& qo)																	{
...
#endif // CHO_MATRIX_H_298374982374

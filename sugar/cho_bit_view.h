...
namespace cho
{
	...
	public:
		...
		template <size_t _elementCount>
		inline constexpr												bit_view				(_tElement (&_dataElements)[_elementCount], uint32_t elementCount)						: Data(_dataElements), Count(::cho::min(_elementCount * ELEMENT_BITS, elementCount))	{
